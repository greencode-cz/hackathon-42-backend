...
set CLASSPATH=%APP_HOME%\lib\cz.greencode.hackathon42-all.jar

@rem Execute cz.greencode.hackathon42
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CZ_GREENCODE_HACKATHON42_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%CZ_GREENCODE_HACKATHON42_EXIT_CONSOLE%" exit 1
exit /b 1
